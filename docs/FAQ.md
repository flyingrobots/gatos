...
- [1) Fold compilation — interpreted YAML or compiled?](#1-fold-compilation--interpreted-yaml-or-compiled)
- [2) Echo integration — do DPO rules become merge strategy for sessions?](#2-echo-integration--do-dpo-rules-become-merge-strategy-for-sessions)
- [3) Proof system — ZK choice?](#3-proof-system--zk-choice)
  - [Phase plan](#phase-plan)
    - [v1 (day-one)](#v1-day-one)
    - [v2 (optional, pluggable)](#v2-optional-pluggable)
  - [Trait](#trait)
  - [Spec tweak](#spec-tweak)
- [4) Message bus scaling — changing shard count](#4-message-bus-scaling--changing-shard-count)
- [5) Policy language (.rgs) — what is it really?](#5-policy-language-rgs--what-is-it-really)
  - [Features](#features)
  - [Shape](#shape)
...
- [Obvious gaps we should close (specification supplements)](#obvious-gaps-we-should-close-specification-supplements)
  - [1. Bind fold version](#1-bind-fold-version)
  - [2. Canonical JSON rules](#2-canonical-json-rules)
  - [3. Error code taxonomy (for JSONL)](#3-error-code-taxonomy-for-jsonl)
...
- [Top 5 use-cases (and if we meet them)](#top-5-use-cases-and-if-we-meet-them)
  - [1. Regulated config / feature flags](#1regulated-config--feature-flags)
  - [2. Supply-chain / deploy attestation](#2supply-chain--deploy-attestation)
  - [3. Air-gapped ML registry](#3air-gapped-ml-registry)
  - [4. LLM multi-agent orchestration](#4llm-multi-agent-orchestration)
  - [5. Cross-app data sharing (RLS-gated state)](#5cross-app-data-sharing-rls-gated-state)
...
- [🎯 Architecture](#-architecture)
  ...
  - [3) Standard library (deterministic subset)](#3-standard-library-deterministic-subset)
- [🧪 Determinism hazards & how we neutralize them](#-determinism-hazards--how-we-neutralize-them)
  - [1. Floating-point drift](#1-floating-point-drift)
  - [2.Table iteration order](#2table-iteration-order)
  - [3.Randomness/time](#3randomnesstime)
  - [4.GC/finalizers](#4gcfinalizers)
  - [5.Bytecode portability](#5bytecode-portability)
  - [6.String hashing / locales](#6string-hashing--locales)
...
<a id="1-fold-compilation--interpreted-yaml-or-compiled"></a>
...
<a id="1"></a><a id="1-fold-compilation--interpreted-yaml-or-compiled"></a><a id="1-fold-compilation-interpreted-yaml-or-compiled"></a>
...
<a id="2-echo-integration--do-dpo-rules-become-merge-strategy-for-sessions"></a>
...
<a id="2"></a><a id="2-echo-integration--do-dpo-rules-become-merge-strategy-for-sessions"></a><a id="2-echo-integration-do-dpo-rules-become-merge-strategy-for-sessions"></a>
...
<a id="3-proof-system--zk-choice"></a>
...
<a id="3"></a><a id="3-proof-system--zk-choice"></a><a id="3-proof-system-zk-choice"></a>
...
<a id="4-message-bus-scaling--changing-shard-count"></a>
...
<a id="5-policy-language-rgs--what-is-it-really"></a>
...
<a id="5"></a><a id="5-policy-language-rgs--what-is-it-really"></a><a id="5-policy-language-.rgs-what-is-it-really"></a>
...
<a id="1-bind-fold-version"></a><a id="1.-bind-fold-version"></a>
...
<a id="2-canonical-json-rules"></a><a id="2.-canonical-json-rules"></a>
...
<a id="3-error-code-taxonomy-for-jsonl"></a><a id="3.-error-code-taxonomy-for-jsonl"></a>
...
<a id="4-resource-uris"></a><a id="4.-resource-uris"></a>
...
<a id="5-idempotency"></a><a id="5.-idempotency"></a>
...
<a id="6-key-rotation"></a><a id="6.-key-rotation"></a>
...
<a id="1regulated-config--feature-flags"></a>
...
<a id="1regulated-config--feature-flags"></a><a id="1.regulated-config-feature-flags"></a>
...
<a id="2supply-chain--deploy-attestation"></a>
...
<a id="3air-gapped-ml-registry"></a>
...
<a id="3air-gapped-ml-registry"></a><a id="3.air-gapped-ml-registry"></a>
...
<a id="4llm-multi-agent-orchestration"></a>
...
<a id="5cross-app-data-sharing-rls-gated-state"></a>
...
<a id="5cross-app-data-sharing-rls-gated-state"></a><a id="5.cross-app-data-sharing-rls-gated-state"></a>
...
<a id="compare--contrast-adjacent-tech"></a><a id="compare-contrast-adjacent-tech"></a>
...
<a id="kafka--eventstoredb--event-logs-at-scale"></a><a id="kafka-eventstoredb-event-logs-at-scale"></a>
...
<a id="dolt--lakefs---data-versioning-with-git-like-semantics"></a><a id="dolt-lakefs-data-versioning-with-git-like-semantics"></a>
...
<a id="dvc--pachyderm--ml-artifact--pipeline-versioning"></a><a id="dvc-pachyderm-ml-artifact-pipeline-versioning"></a>
...
<a id="nix-guix-reproducible-builds"></a>

<a id="nixguix--reproducible-builds"></a>

<a id="nixguix--reproducible-builds"></a><a id="nixguix-reproducible-builds"></a>
**GATOS**:
...
<a id="blockchains--global-consensus"></a><a id="blockchains-global-consensus"></a>
...
<a id="-what-works-and-what-does-not"></a><a id="what-works-and-what-does-not"></a>
...
<a id="3-standard-library-deterministic-subset"></a>
...
<a id="-determinism-hazards--how-we-neutralize-them"></a><a id="determinism-hazards-how-we-neutralize-them"></a>
...
<a id="1-floating-point-drift"></a><a id="1.floating-point-drift"></a>
...
<a id="2table-iteration-order"></a><a id="2.table-iteration-order"></a>
...
<a id="3.randomness-time"></a>

<a id="3randomnesstime"></a>

<a id="3"></a><a id="3randomnesstime"></a>

<a id="3randomnesstime"></a><a id="3.randomnesstime"></a>
...
<a id="6string-hashing--locales"></a><a id="6.string-hashing-locales"></a>
...
<a id="add-these-to-spec-tech-spec"></a>
...
<a id="folds-invoices.lua-authoring"></a>

<a id="foldsinvoiceslua-authoring"></a>

<a id="foldsinvoiceslua-authoring"></a><a id="foldsinvoices.lua-authoring"></a>
