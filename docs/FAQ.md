...
- [Top 5 use-cases (and if we meet them)](#top-5-use-cases-and-if-we-meet-them)
  - [1.Regulated config / feature flags](#1.regulated-config-feature-flags)
  - [2.Supply-chain / deploy attestation](#2.supply-chain-deploy-attestation)
  - [3.Air-gapped ML registry](#3.air-gapped-ml-registry)
  - [4.LLM multi-agent orchestration](#4.llm-multi-agent-orchestration)
  - [5.Cross-app data sharing (RLS-gated state)](#5.cross-app-data-sharing-rls-gated-state)
- [Compare & contrast (adjacent tech)](#compare-contrast-adjacent-tech)
  ...
  - [DVC / Pachyderm — ML artifact + pipeline versioning](#dvc-pachyderm-ml-artifact-pipeline-versioning)
    - [GATOS](#gatos-3)
- [Nix/Guix — reproducible builds](#nix-guix-reproducible-builds)
...
- [🧪 Determinism hazards & how we neutralize them](#determinism-hazards-how-we-neutralize-them)
  ...
  - [2.Table iteration order](#2.table-iteration-order)
  - [3.Randomness/time](#3.randomness-time)
  - [4.GC/finalizers](#4.gc-finalizers)
  - [5.Bytecode portability](#5.bytecode-portability)
  - [6.String hashing / locales](#6.string-hashing-locales)
  - [Where Lua shines here](#where-lua-shines-here)
- [Spec deltas to support EchoLua](#spec-deltas-to-support-echolua)
  - [Add these to `SPEC/TECH-SPEC`](#add-these-to-spec-tech-spec)
- [Minimal example](#minimal-example)
  - [folds/invoices.lua (authoring)](#folds-invoices.lua-authoring)
  - [Build](#build)
