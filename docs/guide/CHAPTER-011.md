...
- [The Cache Plane and Explorer Off-Ramps](#the-cache-plane-and-explorer-off-ramps)
  ...
  - [GATOS-to-SQL/Parquet Explorer](#gatos-to-sqlparquet-explorer)
...
<a id="gatos-to-sqlparquet-explorer"></a>
...
<a id="cache-invalidation-strategy"></a><a id="cache-invalidation-oneliner"></a>
