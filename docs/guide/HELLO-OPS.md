...
<a id="hello-gatos--operations-path"></a><a id="hello-gatos-operations-path"></a>

<!-- AUTOGENERATED TOC START -->

- [0. Initialize and Configure Remotes](#0-initialize-and-configure-remotes)
- [1. Append a Governed Event](#1-append-a-governed-event)
- [2. Fold to State and Inspect](#2-fold-to-state-and-inspect)
- [3. Enqueue a Job and Observe PoE](#3-enqueue-a-job-and-observe-poe)
- [4. Push via Stargate (Optional)](#4-push-via-stargate-optional)
...
<a id="0-initialize-and-configure-remotes"></a><a id="0.-initialize-and-configure-remotes"></a>
...
<a id="1-append-a-governed-event"></a><a id="1.-append-a-governed-event"></a>
...
<a id="2-fold-to-state-and-inspect"></a><a id="2.-fold-to-state-and-inspect"></a>
...
<a id="3-enqueue-a-job-and-observe-poe"></a><a id="3.-enqueue-a-job-and-observe-poe"></a>
...
<a id="4-push-via-stargate-optional"></a><a id="4.-push-via-stargate-optional"></a>
