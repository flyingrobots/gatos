...
3.  **The State Plane (`gatos-echo`, `gatos-kv`)**
    ...
    See [[[[SPEC §5.4](/SPEC#5.4)](/SPEC#5.4)](/SPEC#5.4) — Proof-of-Fold (PoF)](../SPEC.md#5.4-proof-of-fold) for the formal verification link between ledger windows, policy roots, and state checkpoints.
