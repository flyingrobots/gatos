...
- [**M3 — Message Bus (Commit-backed Pub/Sub)**](#m3-message-bus-commit-backed-pub-sub)
  - [Goals](#goals-3)
...
- [**M7 — Proof-of-Experiment (PoX) & Reproduce/Verify**](#m7-proof-of-experiment-pox-reproduce-verify)
  - [Goals](#goals-7)
