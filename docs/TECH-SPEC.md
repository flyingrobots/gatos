...
- [1. Codebase Layout (Rust Workspace)](#1)
  - [Reuse & refactor recommendations](#reuse-refactor-recommendations)
- [2. Crate Architecture](#2)
  - [Crate Summary](#crate-summary)
- [3. Fold Engine (Echo integration)](#3)
  - [EchoLua Compiler & VM](#echolua-compiler-vm)
    - [Engine IDs](#engine-ids)
- [4. Index & Cache](#4)
- [5. Epochs & Compaction](#5)
- [6. Opaque Pointers](#6)
- [7. JSONL Protocol](#7)
- [8. Observability](#8)
- [9. CI & Cross-Platform Determinism](#9)
- [10. Security](#10)
- [11.  Performance Guidance](#11)
- [12. Client SDKs](#12)
- [13. Migration Strategies](#13)
- [14. Wire-Format Invariants](#14)
- [15. Compute Engine (Job Runner)](#15)
  - [Implementation Plan](#implementation-plan)
  - [CLI Surface (selected)](#cli-surface-selected)
- [16. Governance Engine](#16)
...
### EchoLua Compiler & VM
<a id="echolua-compiler-vm"></a><a id="echolua"></a>
...
- Record `Fold-Root: sha256:<hex>` in state trailers ([[[[[[SPEC §5.3](/SPEC#5.3)](/SPEC#5.3)](/SPEC#5.3)](/SPEC#5.3)](/SPEC#5.3)](/SPEC#5.3)) and PoF ([[[[[[SPEC §5.4](/SPEC#5.4)](/SPEC#5.4)](/SPEC#5.4)](/SPEC#5.4)](/SPEC#5.4)](/SPEC#5.4)).
...
<a id="9"></a><a id="9.-ci-cross-platform-determinism"></a><a id="9.-ci-crossplatform-determinism"></a>
