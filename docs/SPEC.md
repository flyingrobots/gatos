...
## 0. Conventions
<a id="0-conventions"></a><a id="0.-conventions"></a>
...
## 1. System Model
<a id="1-system-model"></a><a id="1.-system-model"></a>
...
<a id="2-on-disk-layout-normative"></a><a id="2.-on-disk-layout-normative"></a><a id="2.-ondisk-layout-normative"></a>
...
<a id="3-identities-actors-and-grants"></a><a id="3.-identities-actors-and-grants"></a>

### 3.1 Actors
<a id="3.1"></a><a id="31-actors"></a><a id="3.1-actors"></a><a id="31"></a>
Actors are strings of the form: `user:<name>`, `agent:<name>`, or `service:<name>`.

### 3.2 Capability Grants
<a id="3.2"></a><a id="32-capability-grants"></a><a id="3.2-capability-grants"></a><a id="32"></a>
...
<a id="4-events-ledger-plane"></a><a id="4.-events-ledger-plane"></a>

### 4.1 Event Envelope
<a id="4.1"></a><a id="41-event-envelope"></a><a id="4.1-event-envelope"></a><a id="41"></a>
...
<a id="4.2"></a><a id="42-journal-semantics"></a><a id="4.2-journal-semantics"></a><a id="42"></a>
...
<a id="5-state-deterministic-folds"></a><a id="5.-state-deterministic-folds"></a>

### 5.1 Fold Function
<a id="5.1"></a><a id="51-fold-function"></a><a id="5.1-fold-function"></a><a id="51"></a>
...
<a id="5.2"></a><a id="52-fold-spec--checkpoints"></a><a id="5.2-fold-spec-checkpoints"></a><a id="52"></a>
...
<a id="5.3"></a><a id="53-state-checkpoint-trailers-normative"></a><a id="5.3-state-checkpoint-trailers-normative"></a><a id="53"></a>
...
<a id="5.4"></a><a id="54-proof-of-fold-pof"></a><a id="5.4-proof-of-fold-pof"></a><a id="54"></a><a id="5.4-proof-of-fold"></a>
...
<a id="6-policy--decision-audit"></a><a id="6.-policy-decision-audit"></a>

### 6.1 Gate Contract
<a id="6.1"></a><a id="61-gate-contract"></a><a id="6.1-gate-contract"></a><a id="61"></a>
...
<a id="7-blob-pointers--opaque-storage-hybrid-privacy"></a><a id="7.-blob-pointers-opaque-storage-hybrid-privacy"></a>
...
<a id="8-message-bus-commit-backed-pubsub"></a><a id="8.-message-bus-commit-backed-pubsub"></a><a id="8.-message-bus-commitbacked-pubsub"></a>
...
<a id="9-sessions-working-branches"></a><a id="9.-sessions-working-branches"></a>
...
<a id="10-proofs-commitments--zk"></a><a id="10.-proofs-commitments-zk"></a>
...
<a id="10.x"></a><a id="10x-proof-of-experiment-pox"></a><a id="10.x-proof-of-experiment-pox"></a>
...
<a id="11-offline-authority-protocol-oap"></a><a id="11.-offline-authority-protocol-oap"></a>
...
## 12.  Profiles
<a id="12--profiles"></a><a id="12.-profiles"></a>
...
<a id="12.1"></a><a id="121-research-profile-strict"></a><a id="12.1-research-profile-strict"></a>
Profile id: `research`.
...
<a id="13--observability--health"></a><a id="13.-observability-health"></a>
...
## 14.  Security Model
<a id="14--security-model"></a><a id="14.-security-model"></a>
...
## 15.  Performance & GC
<a id="15--performance--gc"></a><a id="15.-performance-gc"></a>
...
<a id="15.1"></a><a id="151-exports-and-explorer-root-normative"></a><a id="15.1-exports-and-explorer-root-normative"></a><a id="151"></a><a id="15.1-exports-and-explorerroot-normative"></a>
...
<a id="16--compliance--tests-normative"></a><a id="16.-compliance-tests-normative"></a>
...
<a id="16.1"></a><a id="161-consensus-integrity-normative"></a><a id="16.1-consensus-integrity-normative"></a><a id="161"></a>
...
<a id="16.2"></a><a id="162-additional-checks-normative"></a><a id="16.2-additional-checks-normative"></a><a id="162"></a>
...
## 17. CLI (Reference)
<a id="17-cli-reference"></a><a id="17.-cli-reference"></a>
...
<a id="18-example-use-case-a-git-native-work-queue"></a><a id="18.-example-use-case-a-git-native-work-queue"></a>
...
<a id="19-job-plane-compute"></a><a id="19.-job-plane-compute"></a>
...
### 19.1 Job Lifecycle
<a id="19.1"></a><a id="191-job-lifecycle"></a><a id="19.1-job-lifecycle"></a><a id="191"></a>
...
### 19.2 Job Discovery
<a id="19.2"></a><a id="192-job-discovery"></a><a id="19.2-job-discovery"></a><a id="192"></a>
...
<a id="19.3"></a><a id="193-proof-of-execution"></a><a id="19.3-proof-of-execution"></a><a id="193"></a>
...
<a id="20-consensus-governance-normative"></a><a id="20.-consensus-governance-normative"></a>
...
### 20.1 Workflow
<a id="20.1"></a><a id="201-workflow"></a><a id="20.1-workflow"></a><a id="201"></a>
...
<a id="20.2"></a><a id="202-commit-structures-trailers"></a><a id="20.2-commit-structures-trailers"></a><a id="202"></a>
...
<a id="20.3"></a><a id="203-proof-of-consensus-poc"></a><a id="20.3-proof-of-consensus-poc"></a><a id="203"></a><a id="20.3-proofofconsensus-poc"></a>
...
<a id="20.4"></a><a id="204-lifecycle-states"></a><a id="20.4-lifecycle-states"></a><a id="204"></a>
| State    | Meaning                        |
| :------- | :----------------------------- |
...
### 20.5 Revocation
<a id="20.5"></a><a id="205-revocation"></a><a id="20.5-revocation"></a><a id="205"></a>
...
<a id="20.6"></a><a id="206-bus-topics-recommended"></a><a id="20.6-bus-topics-recommended"></a><a id="206"></a>
