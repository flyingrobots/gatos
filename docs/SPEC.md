...
- [3. Identities, Actors, and Grants](#3.-identities-actors-and-grants)
  ...
  - [3.2 Capability Grants](#3.2-capability-grants)
- [4. Events (Ledger Plane)](#4.-events-ledger-plane)
  - [4.1 Event Envelope](#4.1-event-envelope)
  - [4.2 Journal Semantics](#4.2-journal-semantics)
- [5. State (Deterministic Folds)](#5.-state-deterministic-folds)
  - [5.1 Fold Function](#5.1-fold-function)
  - [5.2 Fold Spec & Checkpoints](#5.2-fold-spec-checkpoints)
  - [5.3 State Checkpoint Trailers (Normative)](#5.3-state-checkpoint-trailers-normative)
  - [5.4 Proof-of-Fold (PoF)](#5.4-proof-of-fold-pof)
- [6. Policy & Decision Audit](#6.-policy-decision-audit)
  - [6.1 Gate Contract](#6.1-gate-contract)
- [7. Blob Pointers & Opaque Storage (Hybrid Privacy)](#7.-blob-pointers-opaque-storage-hybrid-privacy)
- [8. Message Bus (Commit-Backed Pub/Sub)](#8.-message-bus-commit-backed-pub-sub)
- [9. Sessions (Working Branches)](#9.-sessions-working-branches)
- [10. Proofs (Commitments / ZK)](#10.-proofs-commitments-zk)
  - [10.x Proof-of-Experiment (PoX)](#10.x-proof-of-experiment-pox)
- [11. Offline Authority Protocol (OAP)](#11.-offline-authority-protocol-oap)
- [12.  Profiles](#12.-profiles)
  - [12.1 Research Profile (Strict)](#12.1-research-profile-strict)
- [13.  Observability & Health](#13.-observability-health)
- [14.  Security Model](#14.-security-model)
- [15.  Performance & GC](#15.-performance-gc)
  - [15.1 Exports and Explorer-Root (Normative)](#15.1-exports-and-explorer-root-normative)
- [16.  Compliance & Tests (Normative)](#16.-compliance-tests-normative)
  - [16.1 Consensus Integrity (Normative)](#16.1-consensus-integrity-normative)
  - [16.2 Additional Checks (Normative)](#16.2-additional-checks-normative)
...
- [19. Job Plane (Compute)](#19.-job-plane-compute)
  - [19.1 Job Lifecycle](#19.1-job-lifecycle)
  - [19.2 Job Discovery](#19.2-job-discovery)
  - [19.3 Proof-Of-Execution](#19.3-proof-of-execution)
- [20. Consensus Governance (Normative)](#20.-consensus-governance-normative)
  - [20.1 Workflow](#20.1-workflow)
  - [20.2 Commit Structures (Trailers)](#20.2-commit-structures-trailers)
  - [20.3 Proof-Of-Consensus (PoC)](#20.3-proof-of-consensus-poc)
  - [20.4 Lifecycle States](#20.4-lifecycle-states)
  - [20.5 Revocation](#20.5-revocation)
  - [20.6 Bus Topics (recommended)](#20.6-bus-topics-recommended)
- [Glossary](#glossary)
