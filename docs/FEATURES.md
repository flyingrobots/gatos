...
<a id="gatos--features-derived-from-spec-v03"></a><a id="gatos-features-derived-from-spec-v0.3"></a>
...
<a id="f1--append-only-journals-ff-only-refs"></a><a id="f1-append-only-journals-ff-only-refs"></a>
...
<a id="f1-acceptance-criteria--dor"></a><a id="acceptance-criteria-dor"></a>
...
#### F1 Test Plan
<a id="f1-test-plan"></a><a id="test-plan"></a>
...
<a id="f1-acceptance-criteria"></a><a id="acceptance-criteria"></a>
- [ ] Every deny → `audit.decision` with rule and reason
- [ ] Policy\_root and trust\_chain recorded

#### F1 Test Plan
<a id="f1-test-plan-1"></a><a id="test-plan"></a>
...
<a id="f2--deterministic-folds--state-roots"></a><a id="f2-deterministic-folds-state-roots"></a>
...
<a id="f2-acceptance-criteria"></a><a id="acceptance-criteria"></a>
- [ ] Canonical serializer used; BLAKE3 hash stable across OS/arch
- [ ] Fold spec validated before run

#### F2 Test Plan
<a id="f2-test-plan"></a><a id="test-plan"></a>
...
<a id="f3--policy-gate-pure-deterministic"></a><a id="f3-policy-gate-pure-deterministic"></a>
...
<a id="f3-acceptance-criteria"></a><a id="acceptance-criteria"></a>
- [ ] Policy VM forbids I/O, clock, RNG
- [ ] `policy_root` bound to every ALLOW

#### F3 Test Plan
<a id="f3-test-plan"></a><a id="test-plan"></a>
...
<a id="f4--capability-grants--trust-graph"></a><a id="f4-capability-grants-trust-graph"></a>
...
<a id="f4-acceptance-criteria"></a><a id="acceptance-criteria"></a>
- [ ] Quorum thresholds enforced
- [ ] Grant chains verify ancestry

#### F4 Test Plan
<a id="f4-test-plan"></a><a id="test-plan"></a>
...
<a id="f5--message-bus-qos-with-ackscommits"></a><a id="f5-message-bus-qos-with-ackscommits"></a>
...
<a id="f5-acceptance-criteria"></a><a id="acceptance-criteria"></a>
- [ ] `gmb.msg` + `gmb.ack` + `gmb.commit` protocol
- [ ] De-dup by (topic, ulid)

#### F5 Test Plan
<a id="f5-test-plan"></a><a id="test-plan"></a>
...
<a id="f6--opaque-pointers--cas"></a><a id="f6-opaque-pointers-cas"></a>
...
<a id="f6-acceptance-criteria"></a><a id="acceptance-criteria"></a>
- [ ] Pointer includes plaintext hash, ciphertext hash, cipher meta
- [ ] Rekey operation available

#### F6 Test Plan
<a id="f6-test-plan"></a><a id="test-plan"></a>
...
<a id="f7--epochs--compaction"></a><a id="f7-epochs-compaction"></a>
...
<a id="f8--observability--doctor"></a><a id="f8-observability-doctor"></a>
...
<a id="f8-acceptance-criteria"></a><a id="acceptance-criteria"></a>
- [ ] `/healthz`, `/readyz`, `/metrics` exposed
- [ ] `gatos doctor` covers refs, packs, epochs, caches

#### F8 Test Plan
<a id="f8-test-plan"></a><a id="test-plan"></a>
