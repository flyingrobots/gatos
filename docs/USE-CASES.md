...
- [1) Programmable Git (Policy-Enforced Repos)](#1-programmable-git-policy-enforced-repos)
- [2) Distributed State Machines (Deterministic)](#2-distributed-state-machines-deterministic)
- [3) Distributed General Computer (Agents on a Bus)](#3-distributed-general-computer-agents-on-a-bus)
- [4) Supply-Chain & Deploy Attestation](#4-supply-chain-deploy-attestation)
- [5) Air-Gapped ML Registry](#5-air-gapped-ml-registry)
- [6) Cross-App Data Sharing (RLS-gated)](#6-cross-app-data-sharing-rls-gated)
- [7) Knowledge Graph for Code & Ops](#7-knowledge-graph-for-code-ops)
- [8) Regulated Feature Flags & Config](#8-regulated-feature-flags-config)
...
<a id="1-programmable-git-policy-enforced-repos"></a>
|               |                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------- |
...
<a id="2-distributed-state-machines-deterministic"></a>
|               |                                                                           |
| ------------- | ------------------------------------------------------------------------- |
...
<a id="3-distributed-general-computer-agents-on-a-bus"></a>
|               |                                                                                         |
| ------------- | --------------------------------------------------------------------------------------- |
...
<a id="4-supply-chain-deploy-attestation"></a>
|               |                                                                                                           |
| ------------- | --------------------------------------------------------------------------------------------------------- |
...
<a id="5-air-gapped-ml-registry"></a>
|               |                                                                                          |
| ------------- | ---------------------------------------------------------------------------------------- |
...
<a id="6-cross-app-data-sharing-rls-gated"></a>
|               |                                                                                                                |
| ------------- | -------------------------------------------------------------------------------------------------------------- |
...
<a id="7-knowledge-graph-for-code-ops"></a>
|               |                                                                  |
| ------------- | ---------------------------------------------------------------- |
...
<a id="8-regulated-feature-flags-config"></a>
|               |                                                          |
| ------------- | -------------------------------------------------------- |
